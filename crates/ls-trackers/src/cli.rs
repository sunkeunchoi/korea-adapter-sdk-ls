...
mod tests {
    ...
    fn freshness_check_over_recommended_set_counts_and_finds_none_under_backstop() {
        ...
        // CSPAT00801 dated 2026-07-13. Evaluated at 2026-10-01 all seven are under the
        // 90-day age backstop (t1101/token/S3_ 87 days, CSPAQ12200/t1102/t0425/CSPAT00801
        // 80 days) — so the run counts the seven Recommended TRs but finds nothing stale
        ...
        assert_eq!(report.recommended_count, 7);
