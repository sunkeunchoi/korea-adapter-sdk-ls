...
mod tests {
    ...
    fn renormalize_from_committed_raw_is_deterministic_and_v2() {
        ...
        assert_eq!(run.shapes.len(), 134, "one-hundred-thirty-four maintained shapes");
...
"#;
    ...
    fn promote_clean_run_advances_baseline_and_appends_record() {
        ...
        assert!(
            matches!(outcome, PromoteOutcome::Promoted { gated: false, maintained_shapes } if maintained_shapes == 134)
        );
        ...
        assert_eq!(committed.shapes.len(), 134);
        assert!(
