...
mod tests {
    ...
    fn freshness_check_over_recommended_set_counts_and_finds_none_under_backstop() {
        ...
        // CSPAQ12200 and t1102 dated 2026-07-13. Evaluated at 2026-10-01 all five are
        // under the 90-day age backstop (t1101/token/S3_ 87 days, CSPAQ12200/t1102 80
        // days) — so the run counts the five Recommended TRs but finds nothing stale and
        // exits zero; the cli's validate→evaluate→exit wiring is exercised over a
        ...
        assert_eq!(report.recommended_count, 5);
