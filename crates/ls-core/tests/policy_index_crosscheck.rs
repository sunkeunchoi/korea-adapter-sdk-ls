...
use ls_core::endpoint_policy::{
    ...
    CSPAQ12300_POLICY, CSPAQ22200_POLICY, CSPAT00601_POLICY, T0425_POLICY, K3_POLICY, REVOKE_POLICY,
...
fn slice_policies_mirror_metadata_index() {
    ...
    let policies: &[EndpointPolicy] = &[
        ...
        CSPAQ12300_POLICY,
        CSPAQ22200_POLICY,
        // First order policy (is_order: true). Registered HERE only — it must NOT
