...
use ls_core::endpoint_policy::{
    CSPAQ12200_POLICY, CSPAQ12300_POLICY, REVOKE_POLICY, S3_POLICY, T1101_POLICY, T1102_POLICY,
    ...
    T1485_POLICY, T1511_POLICY, T1514_POLICY, T1516_POLICY, T1964_POLICY, T3341_POLICY,
