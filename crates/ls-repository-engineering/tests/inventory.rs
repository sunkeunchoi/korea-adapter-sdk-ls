...
fn loader_fixture() -> PathBuf {
    ...
    for relative in [
        ...
        ".repository-engineering/scenarios/audit-carried-rows/comparison-cases.toml",
        ...
        "tools/repository-engineering-runtime/tests/driver.rs",
        "tools/repository-engineering-runtime/tests/checkpoint_recovery.rs",
        "tools/repository-engineering-runtime/tests/effect_recovery.rs",
    ] {
