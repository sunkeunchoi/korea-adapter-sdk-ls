...
mod tests {
    ...
    fn reference_covers_implemented_with_banner_and_omits_unimplemented() {
        ...
        // index + 19 implemented pages (13 banner [revoke + the 11 prior wave TRs
        // + t1866] + token + t1101 + t1102 + t8412 + S3_ + CSPAQ12200). Promoted
        // TRs stay implemented, so the count only grows as TRs implement.
        assert_eq!(
            reference.len(),
            20,
