//! The edit surface end to end: the happy path, AE3 and destructive-transition
//! hygiene (KTD6), staleness, supersede, the malformed-queue typed error, and
//! the argv refusals.
//!
//! Grouped together because every one of them asserts on a WRITE and its
//! refusal wording — none reads the window-aware report.
