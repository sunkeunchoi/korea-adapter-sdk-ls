...
| `S3_` | `live-smoke-ws` | `live_smoke_ws` | paper WS port reachable | ready | **websocket lifecycle reachability only** (delegates to the generic `ws_lifecycle_smoke(tr_cd, tr_key, tr_type)` helper) |
